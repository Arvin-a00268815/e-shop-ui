...
//e.g. <WineDetails wine={this.state.selectedWine}/>
        ...
        <div id="div-item-details">
            <section>
                {/* This is the syntax for comments inside JSX blocks, need to use block comments
                    wrapped within {}. */}
                {/* We do not want to be able to edit the wine Id directly so we disable the input field.
                    Here we are adding a label and a text input field for each property of the wine we want to show.
                    ...
                    which will update the state of the selectedWine causing this component to be re-rendered. 
                */}
